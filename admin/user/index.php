...
if (isset($_GET['search']) &&  $_GET['search'] != null) {
    $search = $_GET['search'];
    $sql = "SELECT users.*,roles.name as role_name FROM users,roles  WHERE users.role_id=roles.id AND users.deleted=0 AND users.email like '%$search%' ORDER BY id ";
    
} else {
    $sql = "SELECT users.*,roles.name as role_name FROM users,roles  WHERE users.role_id=roles.id AND users.deleted=0 ORDER BY id  LIMIT $currentIndex, $page_number_max";
}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-12">
                    <h1 class="m-0 mb-3">DANH SÁCH QUẢN TRỊ</h1>
